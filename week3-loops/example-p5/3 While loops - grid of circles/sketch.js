...
function draw(){
  ...
  while(counter < (width/step)*(height/step)) {
    ...
    fill(253, 218, 13); // set the colour
    ellipse(x,y,step,step); // draws a circle using the variable x and y as the positions and sets the size
    ...
    // the counter is incremented on each iteration to move onto draw the next circle
    counter++;
  }
